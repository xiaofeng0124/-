...
const POPULAR_POOL = [
  ...
  { name: 'Apple iPhone 16', price: 99 },
  { name: 'Samsung Galaxy S25', price: 199 },
  { name: 'MacBook Air M4', price: 99 },
  { name: 'MacBook Pro 16" M4 Pro', price: 199 },
  { name: 'AirPods Pro 3', price: 199 },
  { name: 'AirPods 4', price: 99 },
  { name: 'Sony WH-1000XM6 Headphones', price: 99 },
  { name: 'Apple Watch Ultra 3', price: 299 },
  { name: 'Apple Watch Series 10', price: 199 },
  { name: 'PlayStation 5 Slim', price: 99 },
  { name: 'Xbox Series X 2TB', price: 99 },
  { name: 'Nintendo Switch 2', price: 99 },
  { name: 'Nike Air Max 2025', price: 199 },
  { name: 'Adidas Ultraboost Light', price: 299 },
  { name: 'New Balance 990v6', price: 99 },
  { name: 'Nike Air Force 1', price: 99 },
  { name: 'Crocs Classic Clogs', price: 99 },
  { name: 'UGG Classic Boots', price: 99 },
  { name: 'Levi 501 Original Jeans', price: 199 },
  { name: 'Champion Hoodie', price: 99 },
  { name: 'Instant Pot Duo Plus', price: 99 },
  { name: 'KitchenAid Stand Mixer', price: 99 },
  { name: 'Dyson V15 Detect', price: 99 },
  { name: 'Ninja Creami Deluxe', price: 99 },
  { name: 'Keurig K-Elite Coffee', price: 99 },
  { name: 'Peloton Bike+', price: 299 },
  { name: 'Bowflex Adjustable Dumbbells', price: 99 },
  { name: 'Apple AirTag 4 Pack', price: 99 },
  ...
  { name: 'Women Running Shoes', price: 99 },
  { name: 'Fleece Pullover', price: 39 },
  { name: 'Vitamix Blender', price: 99 },

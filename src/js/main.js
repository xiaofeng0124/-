...
const POPULAR_POOL = [
  ...
  { name: 'Apple iPhone 16', price: 49 },
  { name: 'Samsung Galaxy S25', price: 199 },
  { name: 'MacBook Air M4', price: 49 },
  { name: 'MacBook Pro 16" M4 Pro', price: 199 },
  { name: 'AirPods Pro 3', price: 199 },
  { name: 'AirPods 4', price: 99 },
  { name: 'Sony WH-1000XM6 Headphones', price: 49 },
  { name: 'Apple Watch Ultra 3', price: 299 },
  { name: 'Apple Watch Series 10', price: 199 },
  { name: 'PlayStation 5 Slim', price: 49 },
  { name: 'Xbox Series X 2TB', price: 49 },
  { name: 'Nintendo Switch 2', price: 49 },
  { name: 'Nike Air Max 2025', price: 199 },
  { name: 'Adidas Ultraboost Light', price: 299 },
  { name: 'New Balance 990v6', price: 49 },
  { name: 'Nike Air Force 1', price: 49 },
  { name: 'Crocs Classic Clogs', price: 49 },
  { name: 'UGG Classic Boots', price: 49 },
  { name: 'Levi 501 Original Jeans', price: 199 },
  { name: 'Champion Hoodie', price: 49 },
  { name: 'Instant Pot Duo Plus', price: 49 },
  { name: 'KitchenAid Stand Mixer', price: 49 },
  { name: 'Dyson V15 Detect', price: 49 },
  { name: 'Ninja Creami Deluxe', price: 49 },
  { name: 'Keurig K-Elite Coffee', price: 49 },
  { name: 'Peloton Bike+', price: 299 },
  { name: 'Bowflex Adjustable Dumbbells', price: 49 },
  { name: 'Apple AirTag 4 Pack', price: 49 },

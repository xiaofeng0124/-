...
function showPremiumWelcome(email) {
  ...
  textGroup.style.cssText = 'position:absolute;left:50%;top:22vh;transform:translateX(-50%);z-index:1;text-align:center;white-space:nowrap';
  const text = document.createElement('div');
  text.textContent = '✨ Welcome back, ' + name + ' ✨  ⭐ Premium Member';
  text.style.cssText = 'font-size:46px;font-weight:900;color:#FFD700;text-shadow:0 0 30px rgba(255,215,0,0.6),0 0 60px rgba(255,215,0,0.3),0 4px 12px rgba(0,0,0,0.3);animation:premiumFadeIn 0.6s ease-out;letter-spacing:2px';

...
const POPULAR_POOL = [
  ...
  { name: 'Apple iPhone 16', price: 69 },
  { name: 'Samsung Galaxy S25', price: 199 },
  { name: 'MacBook Air M4', price: 69 },
  { name: 'MacBook Pro 16" M4 Pro', price: 199 },
  { name: 'AirPods Pro 3', price: 199 },
  { name: 'AirPods 4', price: 99 },
  { name: 'Sony WH-1000XM6 Headphones', price: 69 },
  { name: 'Apple Watch Ultra 3', price: 299 },
  { name: 'Apple Watch Series 10', price: 199 },
  { name: 'PlayStation 5 Slim', price: 69 },
  { name: 'Xbox Series X 2TB', price: 69 },
  { name: 'Nintendo Switch 2', price: 69 },
  { name: 'Nike Air Max 2025', price: 199 },
  { name: 'Adidas Ultraboost Light', price: 299 },
  { name: 'New Balance 990v6', price: 69 },
  { name: 'Nike Air Force 1', price: 69 },
  { name: 'Crocs Classic Clogs', price: 69 },
  { name: 'UGG Classic Boots', price: 69 },
  { name: 'Levi 501 Original Jeans', price: 199 },
  { name: 'Champion Hoodie', price: 69 },
  { name: 'Instant Pot Duo Plus', price: 69 },
  { name: 'KitchenAid Stand Mixer', price: 69 },
  { name: 'Dyson V15 Detect', price: 69 },
  { name: 'Ninja Creami Deluxe', price: 69 },
  { name: 'Keurig K-Elite Coffee', price: 69 },
  { name: 'Peloton Bike+', price: 299 },
  { name: 'Bowflex Adjustable Dumbbells', price: 69 },
  { name: 'Apple AirTag 4 Pack', price: 69 },
  ...
  { name: 'Women Running Shoes', price: 69 },
  { name: 'Fleece Pullover', price: 39 },
  { name: 'Vitamix Blender', price: 199 },
  { name: 'Breville Espresso Machine', price: 299 },
  { name: 'iRobot Roomba Vacuum', price: 299 },
  ...
  { name: 'Storage Cabinet', price: 69 },
  { name: 'Floor Lamp Modern', price: 39 },
  { name: 'Samsung 65 Inch OLED TV', price: 299 },
  { name: 'Portable Air Conditioner', price: 99 },
  { name: 'Smart Air Purifier', price: 199 },
  { name: 'Robot Vacuum Mop Combo', price: 69 },
  { name: 'Mini Dehumidifier', price: 99 },
  { name: 'Men Casual Shirt', price: 29 },
  { name: 'Men Winter Jacket', price: 99 },
  { name: 'Men Running Sneakers', price: 29 },
  { name: 'Men Slim Jeans', price: 29 },
  { name: 'Men Leather Watch', price: 199 },
  { name: 'Camping Tent 4 Person', price: 299 },
  { name: 'Hiking Backpack 40L', price: 199 },
  { name: 'Insulated Water Bottle', price: 29 },
  { name: 'Portable Camping Hammock', price: 69 },
  { name: 'Outdoor Propane Grill', price: 299 },
  { name: 'Wireless Phone Charger', price: 69 },
  ...
  { name: 'Vitamin D3 Supplement', price: 99 },

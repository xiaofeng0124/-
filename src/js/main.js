...
function showPremiumWelcome(email) {
  ...
  sub.style.cssText = 'font-size:30px;font-weight:700;color:#FFE082;text-shadow:0 0 20px rgba(255,224,130,0.5),0 2px 8px rgba(0,0,0,0.2);margin-top:12px;animation:premiumFadeIn 0.8s ease-out;letter-spacing:1px';

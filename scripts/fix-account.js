...
// 1. Add sidebar click listeners and fix account page init
s = s.replace(
...
function switchAccountTab(tab) {
  ...
  var sel = '#sidebarNav button[data-tab="' + tab + '"]';
  ...
  switch (tab) {
    ...
    case 'predictions': container.innerHTML = '<div style="text-align:center;padding:60px 20px"><h3 style="font-size:20px;margin-bottom:8px">Price Predictions</h3><p style="color:var(--gray-500)">Coming soon.</p></div>'; break;
    case 'export': container.innerHTML = '<div style="text-align:center;padding:60px 20px"><h3 style="font-size:20px;margin-bottom:8px">Export Data (CSV)</h3><p style="color:var(--gray-500)">Coming soon.</p></div>'; break;
